...
public final class WindsweptFoods {
    ...
    public static final FoodProperties SPICY_SNOW_CONE = new FoodProperties.Builder().nutrition(15).alwaysEat().saturationMod(.6f).effect(new MobEffectInstance(WindsweptEffects.FROST_RESISTANCE, 300, 0), 1f).build();
