...
public enum WindsweptGoatVariant implements StringRepresentable {
    ...
    BROWN(1, "brown", Windswept.id("textures/entity/goat/brown.png")),
    GRAY(2, "gray", Windswept.id("textures/entity/goat/gray.png")),
    ALPINE(3, "alpine", Windswept.id("textures/entity/goat/alpine.png"));
